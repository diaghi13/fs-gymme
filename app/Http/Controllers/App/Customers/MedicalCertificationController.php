...
class MedicalCertificationController extends Controller
{
    ...
    public function update(Request $request, MedicalCertification $medicalCertification)
    {
        ...
        return redirect()->route('app.customers.show', ['customer' => $medicalCertification->medical_certifiable_id])
            ->with('status', 'success')
    ...
    public function destroy(MedicalCertification $medicalCertification)
    {
        ...
        return redirect()->route('app.customers.show', ['customer' => $medicalCertification->customer_id])
            ->with('status', 'success')
