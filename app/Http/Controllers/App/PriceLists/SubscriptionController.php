...
class SubscriptionController extends Controller
{
    ...
    public function store(Request $request, SubscriptionPriceListService $service)
    {
        ...
        return to_route('app.price-lists.subscriptions.show', ['subscription' => $priceList->id])
            ->with('status', 'success');
    }
    ...
    public function update(Request $request, Subscription $subscription, SubscriptionPriceListService $service)
    {
        ...
        return to_route('app.price-lists.subscriptions.show', ['subscription' => $subscription->id])
            ->with('status', 'success');
    }
