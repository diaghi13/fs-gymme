...
class CustomerSubscriptionStoreRequest extends FormRequest
{
    ...
    {
        return [
            'type' => ['required', 'string', 'in:subscription,entrance_card'],
            ...
            'status' => ['required', 'string', 'in:active,suspended,expired,cancelled'],
    ...
    {
        return [
            'type.required' => 'Il tipo di abbonamento è obbligatorio.',
            'type.in' => 'Il tipo di abbonamento deve essere "abbonamento" o "tessera ingressi".',
            'price_list_id.required' => 'Il listino prezzi è obbligatorio.',
