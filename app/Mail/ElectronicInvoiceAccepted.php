...
class ElectronicInvoiceAccepted extends TenantMailable
{
    ...
    public function envelope(): Envelope
    {
        return $this->buildEnvelope(
            "✅ Fattura Elettronica Accettata - {$this->invoice->transmission_id}"
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.electronic-invoice-accepted',
