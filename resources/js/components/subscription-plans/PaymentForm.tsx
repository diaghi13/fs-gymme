...
const elementStyle = {
  base: {
    ...
    color: '#000',
    lineHeight: '2.4em', // tipico di MUI
    '::placeholder': {
      color: '#9e9e9e',
    },
  },
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              <FormGrid sx={{ flexGrow: 1 }}>
                ...
                <OutlinedInput
                  ...
                  onChange={(e) => setFieldValue('cardHolder', e.target.value)}
                />
              </FormGrid>
              <FormGrid sx={{ flexGrow: 1 }}>
                <FormControl fullWidth>
                  <FormLabel>Data di scadenza</FormLabel>
                  <Box sx={{ ...commonWrapperSx, width: '14.1rem' }}>
